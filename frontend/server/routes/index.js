...
router.get('api/get_playlist_image,', (req, res)=>{
...
//need
// //get users profile
router.get('/profile', jwt.authorize, (req,res)=>{
  //token's user id
  console.log(req.user, 'reqwqw')
  const id = req.user.userId
...
//need
//create new playlist
// router.post('/api/create_playlist', jwt.authorize, (req, res) => {
...
router.delete('/api/delete_playlist/:id', (req, res) => {
    const id = req.params.id
...
router.patch('/api/update_playlist_name/:id', (req, res) => {
    const id = req.params.id
...
router.post('/api/add_song', (req, res) =>{
...
router.get('/api/all_songs', (req, res) => {
...
router.get('/api/playlist_songs/:id', (req, res) => {
...
// router.get('/api/user_playlists', jwt.authorize, (req, res)=>{
...
router.get('/api/liked_playlists', (req, res) =>{
...
// router.post('/api/like_playlist', jwt.authorize, (req, res)=>{
...
// router.get('/api/users_liked_playlists', jwt.authorize, (req, res)=>{
//   const user_id = req.user.userId
...
router.get('/api/count_playlist_likes', (req, res)=>{
...
router.get('/api/playlist_creator', (req, res)=>{
  const playlist_id = req.params.id
...
router.get('/api/playlist_info/:id', (req, res)=>{
  const playlist_id = req.params.id
